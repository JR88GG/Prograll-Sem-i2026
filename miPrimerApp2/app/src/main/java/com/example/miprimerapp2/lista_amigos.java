...
public class lista_amigos extends AppCompatActivity {
    ...
    private void BorrarAmigo(){
        try {
            ...
            confirmacion.setTitle("Estas seguro de borar a?");
            ...
            confirmacion.setPositiveButton("si",(dialog, which)->{
                try {
                    ...
                    mostrarMsg("hola"+e.getMessage());
                }
            });
            confirmacion.setNegativeButton("No",(dialog, wich)->{
              dialog.dismiss();//cerrar el cuadro de dialogo
            });
            confirmacion.create().show();
        } catch (Exception e) {
            mostrarMsg("Error al borar el amigo"+e.getMessage());
        }
    }
    ...
    private void buscarAmigos(){
        ...
        tempVal.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                ...
                ltsAmigos.setAdapter(new Adaptador_Amigos(getApplicationContext(),alAmigos));
                }
            }
        });
    }
